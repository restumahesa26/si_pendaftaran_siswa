                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->status === 0)
                                            <a href="{{ route('admin-pembayaran.konfirmasi-pembayaran', $item->id) }}" class="btn btn-sm btn-info">Konfirmasi Pembayaran</a>
                                            <a href="{{ route('admin-pembayaran.hapus-pembayaran', $item->id) }}" class="btn btn-sm btn-danger">Hapus Pembayaran</a>
                                        @else
                                            <a href="{{ route('admin-pembayaran.batal-pembayaran', $item->id) }}" class="btn btn-sm btn-danger">Batal Pembayaran</a>
                                        @endif
