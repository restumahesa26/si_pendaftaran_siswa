<!-- Scripts -->
    ...
    <script src="{{ url('frontend/assets/js/tabs.js') }}"></script>
    <script src="{{ url('frontend/assets/js/video.js') }}"></script>
    <script src="{{ url('frontend/assets/js/slick-slider.js') }}"></script>
